...
class Ctanim {
 ...
 static String translate(String input) {
  ...
  Map<String, String> translations = {
    ...
    "Kayıt ol": "Sign up",
    "Çıkış yap": "Log out",
    SiteSabit.FirmaAdi! + " B2B'ye Hoş Geldiniz": "Welcome to ${SiteSabit.FirmaAdi!} B2B",
    ...
    "Not: Gireceğiniz mail adresine tarafımızca şifreniz gönderilecekir." : "Note: Your password will be sent to the email address you will enter.",
    "Hata":"Error",
    "Şifre Gönderilecek Alan Adı Boş.":"The field name to send the password is empty.",
    "Böyle Bir Kullanıcı Yok":"There is no such user",
    "Başarılı":"Successful",
    "Tamam":"Okay",
    "Aktif İnternet Bağlantısı Bulunamadı. Tekrar Deneyin.":"Active internet connection not found. Try again.",
    "Şifremi Gönder":"Send my password",
    "İnternet Bağlantısı Yok":"No internet connection",
    "Aktif internet bağlantısı bulunamadı.İnternete bağlı olduğunuzdan emin olun." : "Active internet connection not found. Make sure you are connected to the internet.",
